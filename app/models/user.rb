class User < ApplicationRecord
  ...
  has_many :incoming_collaboration_requests, foreign_key: "producer_id", class_name: "CollaborationRequest", dependent: :destroy
  has_many :outgoing_collaboration_requests, foreign_key: "collaborator_id", class_name: "CollaborationRequest", dependent: :destroy
end
